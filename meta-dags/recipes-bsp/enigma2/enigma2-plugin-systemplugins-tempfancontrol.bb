DESCRIPTION = "Temp and Fan Control"
LICENSE = "GPLv2"
...
S = "${WORKDIR}"
DEST = "${D}/usr/lib/enigma2/python/Plugins/SystemPlugins/TempFanControl"

PR = "r0"

FILES_${PN} = "/usr/lib/enigma2/python/Plugins/SystemPlugins/TempFanControl"
